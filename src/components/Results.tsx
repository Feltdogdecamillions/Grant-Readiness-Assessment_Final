  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-8 p-8 bg-gradient-to-br from-blue-600 to-emerald-600 rounded-2xl shadow-xl text-white">
          <h4 className="font-bold text-2xl mb-3">
            Need Help Becoming Grant Ready?
          </h4>
          <p className="text-blue-50 text-lg mb-6 max-w-2xl mx-auto">
            Contact us for grant readiness consulting. Our team of grant specialists can help you develop a customized plan to improve your grant readiness and secure funding for your mission.
          </p>
          <a
            href="#"
            className="inline-block bg-white text-blue-600 hover:bg-blue-50 font-bold px-8 py-4 rounded-lg transition-colors shadow-lg"
          >
