import { CheckCircle2, Calendar, Clock, Video, AlertCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-r from-amber-400 to-orange-500 rounded-xl shadow-lg p-6 mb-8 text-center">
          <CheckCircle2 className="w-12 h-12 text-slate-900 mx-auto mb-3" />
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          <h2 className="text-2xl font-bold text-slate-900 mb-6">What You'll Get During Your Free Strategy Session</h2>
